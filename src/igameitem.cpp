...
game::IGameItem::itemrarity_e game::IGameItem::Rarity() const
{
    return m_Rarity;
}

void game::IGameItem::setRarity(const game::IGameItem::itemrarity_e &Rarity)
{
    m_Rarity = Rarity;
}

game::IGameItem::itemtype_e game::IGameItem::Type() const
{
    return m_Type;
}

void game::IGameItem::setType(const game::IGameItem::itemtype_e &Type)
{
    m_Type = Type;
}
